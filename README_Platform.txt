...
3. In case of 'device\samsung\smdk_common\alsa-lib',
...
4. You should add module name to 'PRODUCT_PACKAGES' in 'build\target\product\core.mk' as following case.
	...
	case 8) netlink : should add 'libnl' to PRODUCT_PACKAGES
	case 9) Bellagio : should add 'libsteomxil-bellagio' to PRODUCT_PACKAGES

	ex.) [build\target\product\core.mk] - add all module name for case 1 ~ 9at once
...
5. In case of 'bluetooth', you should add following text in 'build\target\board\generic\BoardConfig.mk'
